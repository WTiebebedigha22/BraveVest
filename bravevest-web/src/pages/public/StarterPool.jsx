...
export default function StarterPool() {
  useSEO({
    title: 'Starter Pool â€” Start with â‚¦5,000',
    description: 'New to investing? Start with just â‚¦5,000 in a diversified pool across multiple BraveVest projects.',
    canonical: '/#/starter',
  });
    ...
    <div className="starter container">
      <div className="starter__hero">
        ...
        <div className="starter__inner">
          ...
          <h1 className="starter__title">New to investing?<br />Start with â‚¦5,000.</h1>
          ...
          <div className="starter__actions">
            <Button as={Link} to="/register" variant="primary" size="lg">Start with â‚¦5,000</Button>
      ...
      <div className="starter__grid">
        <div className="starter__card">
          ...
          <p className="starter__card-body">
            Your â‚¦5,000 is spread across a curated bundle of projects â€” real estate,
            agriculture, and energy â€” so you're never exposed to a single project.
          </p>
        </div>
        <div className="starter__card">
        ...
        <div className="starter__card">
          ...
          <p className="starter__card-body">
            Once you're comfortable, move up to full projects with â‚¦50,000+ minimums.
      ...
      <div className="starter__cta">
        <div className="starter__cta-inner">
          ...
          <p className="starter__cta-sub">Create your account in 2 minutes. Complete KYC. Invest from â‚¦5,000.</p>
